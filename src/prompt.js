...
const active_settings = SETTINGS_3;
...
# 出力に関する注意
レスポンスには絶対にstory script「だけ」を記述してください。挨拶や説明その他のことは一切言わないように！
...
# 出力に関する注意
出力にはstory scriptの続き「だけ」を記述してください。
次にプレイヤー（主人公）がやりたいことからはじめてください。
